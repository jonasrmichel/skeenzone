...
public class HeartBeatMessage extends Message {
	...
	public HeartBeatMessage(long clockVal, InetAddress sender) {
		super(clockVal, sender);
	}

	private static final long serialVersionUID = -3109859683150143862L;

	@Override
	public Message execute(long myClock, InetAddress myAddress) {
		return new AckMessage(myClock, myAddress);
	}
